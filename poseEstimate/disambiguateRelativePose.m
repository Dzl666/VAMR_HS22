...
%
% Arguments:
%   Rots      -  3x3x2 two possible rotations returned by decomposeEssentialMatrix
%   u3          -  3x1 vector with the translation information returned by decomposeEssentialMatrix
%   p1, p2    -  3xN homogeneous coordinates of point correspondences in image1, 2
%   K1, K2   -  3x3 calibration matrix for camera 1, 2
% Returns:
...
for iRot = 1:2
    ...
    for iSignT = 1:2
        ...
        % project in both cameras [3, N]
        P_C2 = [R_C2_C1_test T_C2_C1_test] * [P_C1; ones(1, size(P_C1, 2))];
        ...
        if (total_points_in_front > total_points_in_front_best)
            % Keep the rotation that gives the highest number of points in front of both cameras
            R = R_C2_C1_test;
            T = T_C2_C1_test;
